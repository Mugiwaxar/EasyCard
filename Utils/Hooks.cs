...
namespace EasyCard.Utils
{
    internal class Hooks
    {
        ...
        public static void AddHooks(Type classType, string methodName, Type[] methodType, Delegate calledMethod)
        {
            ...
            {
                UnityEngine.Debug.LogWarning("EasyCard -> Failed to create hook, argument null: " + classType.Name + "." + methodName + " -> " + calledMethod.Method.Name);
                return;
            }
            ...
            if (method == null)
            {
                UnityEngine.Debug.LogWarning("EasyCard -> Failed to create hook, method null : " + classType.Name + "." + methodName + " -> " + calledMethod.Method.Name);
                return;
            }

            HookEndpointManager.Add(method, calledMethod);
            UnityEngine.Debug.Log("EasyCard -> Hook Added for " + classType.Name + "." + methodName + " -> " + calledMethod.Method.Name);
